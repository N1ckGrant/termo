jQuery(document).ready(function () {
    ...
    }), $(".how_choose_page .how_to_choose .items_wrap .item, .treatment_page .therapy ul li").viewportChecker(), $(".search_page .main .items_wrap .item .body .left .slick_slider").slick({
        infinite: !1,
