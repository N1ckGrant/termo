/*OfferPage /404 /OneHotelPage /PlantingPage - СТРАНИЦЫ, НА КОТОРЫХ РАБОТАЕТ ДАННЫЙ ФАЙЛ*/
...
jQuery(document).ready(function () {
    ...
    $("body").on("click", ".zkt_page .contras .head, .one_hotel_page .contras .head", function () {
    ...
    }), $("body").on("click", ".search_page .main .items_wrap .item .mobile_benefits_btns .switch_btn", function () {
        var e = $(this).hasClass("plus");
        if ($(this).hasClass("active")) return !1;
        $(".search_page .main .items_wrap .item .mobile_benefits_btns .switch_btn").removeClass("active"), $(this).addClass("active"), e ? ($(".search_page .main .items_wrap .item .mobile_benefits ul").removeClass("active"), $(".search_page .main .items_wrap .item .mobile_benefits ul.plus").addClass("active")) : ($(".search_page .main .items_wrap .item .mobile_benefits ul").removeClass("active"), $(".search_page .main .items_wrap .item .mobile_benefits ul.minus").addClass("active"))
    ...
    }), $(".article_page").length && $(".article_page .tags").viewportChecker(), $(".how_choose_page").length && $(".how_choose_page .how_to_choose .items_wrap .item, .treatment_page .therapy ul li").viewportChecker(), $(".planting_page").length && function () {
        ...
        }), window.matchMedia("(max-width: 600px)").matches && $(".planting_page .resorts .items_wrap").slick({
            arrows: !1,
            dots: !0,
            slidesToShow: 2,
            responsive: [{breakpoint: 480, settings: {slidesToShow: 1}}]
        }), $(".planting_page .contras .head").on("click", function () {
            $(this).toggleClass("open")
        }), $(".planting_page").on("mouseleave", ".resorts .items_wrap .item_wrapper", function () {
            $(this).removeClass("hover")
        }), $(".planting_page").on("mouseenter", ".resorts .items_wrap .item_wrapper .text", function () {
            $(this).closest(".item_wrapper").addClass("hover")
        }), $(".planting_page .planting_head .all_links .link").eq(0).on("click", function (e) {
            var o = $(this).attr("href"), a = $(o).offset().top - 80;
            e.preventDefault(), $("body,html").animate({scrollTop: a}, 1500)
        }), $("#one_hotel_modal_gallery .modal_gallery_slider").slick({
            prevArrow: $("#one_hotel_modal_gallery .slick_prev"),
            nextArrow: $("#one_hotel_modal_gallery .slick_next"),
            asNavFor: $("#one_hotel_modal_gallery .modal_gallery_slider_nav"),
            responsive: [{breakpoint: 480, settings: {arrows: !1, dots: !0}}]
        }), $("#one_hotel_modal_gallery .modal_gallery_slider_nav").slick({
            arrows: !1,
            asNavFor: $("#one_hotel_modal_gallery .modal_gallery_slider"),
            slidesToShow: 6,
            focusOnSelect: !0,
            responsive: [{breakpoint: 800, settings: {slidesToShow: 4}}]
        });
        var e = $(".planting_page .planting_head .all_links"), o = $(".main_header"), a = e.offset().top, s = !0;
        $(window).on("scroll", function (t) {
            var i = $(this).scrollTop();
            s && i > a ? (o.css("position", "absolute"), e.addClass("fixed"), s = !1) : !s && i < a && (o.css("position", "fixed"), e.removeClass("fixed"), s = !0)
        })
        ...
        window.matchMedia("(max-width: 800px)").matches && $(".one_hotel_page:not(.offer_page) .hotel_rooms_static .items_wrap").slick({
            slidesToShow: 2,
            arrows: !1,
            dots: !0,
            responsive: [{breakpoint: 480, settings: {slidesToShow: 1}}]
            ...
            dots: !0,
            infinite: !1
        }), $("body").on("click", ".one_hotel_page .hotel_rooms_static .items_wrap .item .content .descr .bilets_wrap .mob_drop", function () {
            $(this).toggleClass("open")
        ...
        }), $(".one_hotel_head_gallery .items_wrap_nav_wrapper, .one_hotel_head_gallery .slick-arrow").on("mouseenter", function () {
            $(".one_hotel_head_gallery .items_wrap_nav_wrapper").addClass("showed")
        }), $(".one_hotel_head_gallery .items_wrap_nav_wrapper, .one_hotel_head_gallery .slick-arrow").on("mouseleave", function () {
            $(".one_hotel_head_gallery .items_wrap_nav_wrapper").removeClass("showed")
            ...
            prevArrow: $("#hotel_room_modal .items_wrap_wrap .slick_prev"),
            nextArrow: $("#hotel_room_modal .items_wrap_wrap .slick_next"),
            asNavFor: $("#hotel_room_modal .hotel_room_modal_gallery .items_wrap_nav"),
            responsive: [{breakpoint: 480, settings: {dots: !0, arrows: !1}}]
        }), $("#hotel_room_modal .hotel_room_modal_gallery .items_wrap_nav").slick({
            slidesToShow: 4,
            asNavFor: $("#hotel_room_modal .hotel_room_modal_gallery .items_wrap"),
            focusOnSelect: !0,
            arrows: !1
        }), $(".one_hotel_page .services .items_wrap .item").viewportChecker();
        var e = $(".one_hotel_page_nav"), o = $(".main_header"), a = e.offset().top, s = !0;
        $(window).on("scroll", function (t) {
            var i;
            !function () {
                var t = $(this).scrollTop();
                s && t > a ? (o.css("position", "absolute"), e.addClass("fixed"), s = !1) : !s && t < a && (o.css("position", "fixed"), e.removeClass("fixed"), s = !0)
    ...
    }(), $(".zkt_page").on("mouseleave", ".resorts .items_wrap .item_wrapper", function () {
        $(this).removeClass("hover")
    }), $(".zkt_page").on("mouseenter", ".resorts .items_wrap .item_wrapper .text", function () {
        $(this).closest(".item_wrapper").addClass("hover")
    }), window.matchMedia("(max-width: 600px)").matches && ($(".children_page .indicators .items_wrap").addClass("drop_down_content"), $(".children_page .by_indicators .items_wrap").slick({
        arrows: !1,
        dots: !0,
        infinite: !1,
        slidesToShow: 2,
        responsive: [{breakpoint: 481, settings: {slidesToShow: 1}}]
    }), $(".treatment_page .hotels .items_wrap").slick({
        arrows: !1,
        dots: !0,
        infinite: !1,
        slidesToShow: 2,
        responsive: [{breakpoint: 481, settings: {slidesToShow: 1}}]
    }), $(".zkt_page .resorts .items_wrap").slick({
        arrows: !1,
        dots: !0,
        slidesToShow: 2,
        responsive: [{breakpoint: 480, settings: {slidesToShow: 1}}]
    })), window.matchMedia("(max-width: 480px)").matches && $(".articles .items_wrap").slick({
        arrows: !1,
        dots: !0,
        infinite: !1
    })
