/*OneArticle/*ZKTPage- СТРАНИЦЫ, НА КОТОРЫХ РАБОТАЕТ ДАННЫЙ ФАЙЛ*/
jQuery(document).ready(function () {
    ...
    $("body").on("click", ".zkt_page .contras .head, .one_hotel_page .contras .head", function () {
        ...
        $(window).on("scroll", function (t) {
            ...
            s && r > a ? (o.css("position", "absolute"), e.addClass("fixed"), s = !1) : !s && r < a && (o.css("position", "fixed"), e.removeClass("fixed"), s = !0)
        })
        ...
        $(window).on("scroll", function (t) {
            ...
            }(), r = $(document).scrollTop(), $(".one_hotel_page_nav .link").each(function () {
                var e, o = $(this).data("linkTo"), a = $(o);
                if (!a.length) return !1;
                (e = a.position().top) <= r && e + a.outerHeight() > r ? ($(".one_hotel_page_nav .link.active").removeClass("active"), $(this).addClass("active")) : $(this).removeClass("active")
            })
        })
