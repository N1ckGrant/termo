/*AllResortsPage/GeneralPage/PersonalBookingPage/PersonalSettingsPage  - СТРАНИЦЫ, НА КОТОРЫХ РАБОТАЕТ ДАННЫЙ ФАЙЛ*/
...
jQuery(document).ready(function () {
    ...
    }), $(".how_choose_page").length && $(".how_choose_page .how_to_choose .items_wrap .item, .treatment_page .therapy ul li").viewportChecker(), $(".planting_page").length && function () {
